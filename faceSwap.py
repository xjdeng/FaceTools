...
def swap(face, body, facenum = 0, bodynum = 0, predictor = None, detector = None):
    ...
    newimg = swap_inplace(i1, i2, facenum, bodynum, predictor, detector)
    return newimg.getimg()

def swap_inplace(face, body, facenum = 0, bodynum = 0, predictor = None, detector = None):
    """
Swaps face # facenum on the "face" image with face # bodynum on the "body" image
and modifies the body EasyImage with the new face.

Note: face and body need to be EasyImage objects! 
    """

    img1 = face.getimg()
    img2 = body.getimg()
    img1Warped = np.copy(img2);
    face1 = face.detect_faces()[facenum]
    face2 = body.detect_faces()[bodynum]    
...
if __name__ == '__main__' :
    ...
    output = swap(filename1, filename2)
